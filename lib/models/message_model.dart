...
final User currentUser =
    User(id: 0, name: 'Deepa Pandey', imageUrl: Colors.red);
...
final User deepak = User(id: 5, name: 'Sai manoj', imageUrl: Colors.red);
final User balram = User(id: 6, name: 'Chandru', imageUrl: Colors.teal);
...
final User digitalocean1 =
    User(id: 9, name: 'Digital Ocean', imageUrl: Colors.greenAccent);
final User digitalocean2 =
    User(id: 10, name: 'Digital Ocean', imageUrl: Colors.lightBlue);
final User digitalocean3 =
    User(id: 11, name: 'Digital Ocean', imageUrl: Colors.amber);
final User digitalocean4 =
    User(id: 12, name: 'Digital Ocean', imageUrl: Colors.pink[700]);
...
List<Message> mails = [
  ...
  Message(
    ...
    time: '9:05 PM',
    text:
        'Stories for Deepa Pandey : How I got an engineering internships in...Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
